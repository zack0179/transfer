...
conf['params']['collins']['widths0 pi+ fav'] = {
    'value': 0.07502, 'fixed': False, 'min': 0.05, 'max': 0.1}
conf['params']['collins']['widths0 pi+ unfav'] = {
    'value': 0.07649, 'fixed': 'widths0 pi+ fav', 'min': 1e-5, 'max': 0.2}
#conf['params']['collins']['widths0 pi+ unfav']   = {'value':0.07649,'fixed':False,'min':1e-5,'max':0.2}
conf['params']['collins']['pi+ u N 1'] = {
    'value': 1.01381, 'fixed': False, 'min': 0, 'max': 4}
conf['params']['collins']['pi+ u a 1'] = {'value': -
                                          1.58758, 'fixed': False, 'min': -0.5, 'max': 0}
conf['params']['collins']['pi+ u b 1'] = {
    'value': 4.77410, 'fixed': False, 'min': 3., 'max': 7.}

conf['params']['collins']['pi+ d N 1'] = {'value': -
                                          7.94373, 'fixed': False, 'min': -15, 'max': -4}
conf['params']['collins']['pi+ d a 1'] = {
    'value': 3.14003, 'fixed': False, 'min': 0., 'max': 4.5}
conf['params']['collins']['pi+ d b 1'] = {
    'value': 3.27627, 'fixed': False, 'min': 2.5, 'max': 3.8}
...
conf['params']['collins']['pi+ u N 2'] = {
    'value': 6.31940, 'fixed': False, 'min': 1, 'max': 12}
conf['params']['collins']['pi+ u a 2'] = {
    'value': 5.53240, 'fixed': False, 'min': 1, 'max': 10}
conf['params']['collins']['pi+ u b 2'] = {
    'value': 3.32471, 'fixed': False, 'min': 3, 'max': 5}
