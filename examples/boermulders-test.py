...
# clas measurement 
conf['datasets']['sidis']['xlsx'][7004]='../database/sidis/expdata/7004.xlsx' # | proton   |pi- | xsec | clas 
conf['datasets']['sidis']['xlsx'][7005]='../database/sidis/expdata/7005.xlsx' # | proton   |pi+ | xsec | clas 

conf['datasets']['sidis']['norm'][7004]={'value':1.00000000000000000000e+00,'fixed':True,'min':-2,'max':2}
conf['datasets']['sidis']['norm'][7005]={'value':1.00000000000000000000e+00,'fixed':True,'min':-2,'max':2}
