...
# babar | k,k | AUL-0     | 16      | z1,z2  |
conf['datasets']['sia']['xlsx'][2000] = '../database/sia/expdata/2000.xlsx'
# babar | k,k | AUC-0     | 16      | z1,z2  |
conf['datasets']['sia']['xlsx'][2002] = '../database/sia/expdata/2002.xlsx'
# babar | k,pi | AUL-0     | 16      | z1,z2  |
conf['datasets']['sia']['xlsx'][2004] = '../database/sia/expdata/2004.xlsx'
# babar | k,pi | AUC-0     | 16      | z1,z2  |
conf['datasets']['sia']['xlsx'][2005] = '../database/sia/expdata/2005.xlsx'
