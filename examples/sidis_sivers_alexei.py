...
# proton   | k+     | AUTsivers  | hermes     | PT
conf['datasets']['sidis']['xlsx'][2009] = '../database/sidis/expdata/2009.xlsx'
# proton   | k+     | AUTsivers  | hermes     | x
conf['datasets']['sidis']['xlsx'][2010] = '../database/sidis/expdata/2010.xlsx'
# proton   | k+     | AUTsivers  | hermes     | z
conf['datasets']['sidis']['xlsx'][2011] = '../database/sidis/expdata/2011.xlsx'
# proton   | k-     | AUTsivers  | hermes     | PT
conf['datasets']['sidis']['xlsx'][2012] = '../database/sidis/expdata/2012.xlsx'
# proton   | k-     | AUTsivers  | hermes     | x
conf['datasets']['sidis']['xlsx'][2013] = '../database/sidis/expdata/2013.xlsx'
# proton   | k-     | AUTsivers  | hermes     | z
conf['datasets']['sidis']['xlsx'][2014] = '../database/sidis/expdata/2014.xlsx'
...
# deuteron | k+     | AUTsivers  | compass    | PT
conf['datasets']['sidis']['xlsx'][2032] = '../database/sidis/expdata/2032.xlsx'
# deuteron | k+     | AUTsivers  | compass    | x
conf['datasets']['sidis']['xlsx'][2033] = '../database/sidis/expdata/2033.xlsx'
# deuteron | k+     | AUTsivers  | compass    | z
conf['datasets']['sidis']['xlsx'][2034] = '../database/sidis/expdata/2034.xlsx'
# deuteron | k-     | AUTsivers  | compass    | PT
conf['datasets']['sidis']['xlsx'][2035] = '../database/sidis/expdata/2035.xlsx'
# deuteron | k-     | AUTsivers  | compass    | x
conf['datasets']['sidis']['xlsx'][2036] = '../database/sidis/expdata/2036.xlsx'
# deuteron | k-     | AUTsivers  | compass    | z
conf['datasets']['sidis']['xlsx'][2037] = '../database/sidis/expdata/2037.xlsx'
# neutron  | k+     | AUTsivers  | jlab    | x
conf['datasets']['sidis']['xlsx'][2038] = '../database/sidis/expdata/2038.xlsx'
# neutron  | k-     | AUTsivers  | jlab    | z
conf['datasets']['sidis']['xlsx'][2039] = '../database/sidis/expdata/2039.xlsx'
