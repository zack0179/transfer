...
conf['datasets']['sidis']['xlsx'][5002] = '../database/sidis/expdata/5002.xlsx'
# | proton   | pi+ | AUUcos2 | hermes
conf['datasets']['sidis']['xlsx'][5003] = '../database/sidis/expdata/5003.xlsx'
...
conf['datasets']['sidis']['xlsx'][5006] = '../database/sidis/expdata/5006.xlsx'
# | deuteron | pi+ | AUUcos2 | hermes
conf['datasets']['sidis']['xlsx'][5007] = '../database/sidis/expdata/5007.xlsx'
