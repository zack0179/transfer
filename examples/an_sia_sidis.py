...
conf['params']['collins']['pi+ u N 1']  = {'value': <<    7.36277445389208473614e-01 >>, 'fixed': False, 'min': 0, 'max': 4}
conf['params']['collins']['pi+ u a 1']  = {'value': <<   -1.86186662524702351007e+00 >>, 'fixed': False, 'min': -2.5, 'max': 0}
conf['params']['collins']['pi+ u b 1']  = {'value': <<    5.38338585620487108940e+00 >>, 'fixed': False, 'min': 3., 'max': 7.}

conf['params']['collins']['pi+ d N 1']  = {'value': <<   -3.74237257542177692571e+00 >>, 'fixed': False, 'min': -15, 'max': 2}
conf['params']['collins']['pi+ d a 1']  = {'value': <<    1.18375029871723347341e+00 >> , 'fixed': False, 'min': 0., 'max': 4.5}
conf['params']['collins']['pi+ d b 1']  = {'value': <<    3.23313786701237937393e+00 >>, 'fixed': False, 'min': 2.5, 'max': 3.8}
...
conf['params']['collins']['pi+ u N 2']  = {'value': <<    9.31781062503573664912e+00 >>, 'fixed': False, 'min': 1, 'max': 52}
conf['params']['collins']['pi+ u a 2']  = {'value': <<    7.23248965969008850152e+00 >>, 'fixed': False, 'min': 1, 'max': 20}
...
conf['params']['transversity']['u a']             = {'value': <<    9.52891908728900727255e-01 >> , 'fixed': False, 'min': -1, 'max': 10}
conf['params']['transversity']['u b']             = {'value': <<    1.74254384461133371431e+00 >> , 'fixed': False, 'min': 1e-5, 'max': 10}
conf['params']['transversity']['d N']             = {'value': <<   -7.94918958255303742533e+00 >> , 'fixed': False, 'min': -20, 'max': 20}
conf['params']['transversity']['d a']             = {'value': <<    3.36191370918958343239e-01 >> , 'fixed': False, 'min': -1, 'max': 5}
conf['params']['transversity']['d b']             = {'value': <<    6.95490679330094074828e+00 >> , 'fixed': False, 'min': 1e-5, 'max': 20}
conf['params']['transversity']['s N']             = {'value': <<   -7.72112662034396685096e-02 >> , 'fixed': False, 'min': -10, 'max': 10}
conf['params']['transversity']['s a']             = {'value': <<   -2.96378252146925369459e-01 >> , 'fixed': False, 'min': -1, 'max': 5}
