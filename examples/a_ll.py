...
conf['params']['ff'] = {}
conf['params']['ff']['widths0 pi+ fav']   = {'value': <<    1.17243549708200278658e-01 >>, 'fixed': False, 'min': 1e-5, 'max': 1}
conf['params']['ff']['widths0 pi+ unfav'] = {'value': <<    1.34923899379786438324e-01 >>, 'fixed': False, 'min': 1e-5, 'max': 1}
...
# integrated datasets
# | neutron | pi+ | ALL | clas
conf['datasets']['sidis']['xlsx'][9000] = '../database/sidis/expdata/9000.xlsx'
# | neutron | pi- | ALL | clas
conf['datasets']['sidis']['xlsx'][9001] = '../database/sidis/expdata/9001.xlsx'
