...
conf['params']['collins'] = {}
conf['params']['collins']['widths0 pi+ fav']     = {'value': <<    1.77011683986804946311e-01 >>, 'fixed': False, 'min': 1e-5, 'max': 1}
conf['params']['collins']['widths0 pi+ unfav']   = {'value': <<    1.11403919510834681361e+00 >>, 'fixed': False, 'min': 1e-5, 'max': 2}
conf['params']['collins']['pi+ u N']  = {'value': <<    2.01929928152821958065e-02 >> , 'fixed': False, 'min': 0, 'max': 1e6}
conf['params']['collins']['pi+ u a']  = {'value': <<   -1.00000000000000000000e+00 >> , 'fixed': False, 'min': -1, 'max': 5}
conf['params']['collins']['pi+ u b']  = {'value': <<    6.01882551399226528588e-02 >> , 'fixed': False, 'min': 1e-5, 'max': 10}
conf['params']['collins']['pi+ d N']  = {'value': <<    0.00000000000000000000e+00 >> , 'fixed': False, 'min': -1000, 'max': 0}
conf['params']['collins']['pi+ d a']  = {'value': <<   -1.00000000000000000000e+00 >> , 'fixed': False, 'min': -1, 'max': 5}
conf['params']['collins']['pi+ d b']  = {'value': <<    3.56842403821459219770e+00 >> , 'fixed': False, 'min': 1e-5, 'max': 10}
...
conf['params']['transversity']['widths0 valence'] = {'value': <<    1.00000000000000008180e-05 >>, 'fixed': False, 'min': 1e-5, 'max': 2}
conf['params']['transversity']['widths0 sea']     = {'value': <<    4.84126169244575077499e-01 >>, 'fixed': False, 'min': 1e-5, 'max': 2}
conf['params']['transversity']['u N']             = {'value': <<    1.00000000000000000000e+01 >> , 'fixed': False, 'min': -10, 'max': 10}
conf['params']['transversity']['u a']             = {'value': <<    1.21856252702636780327e-01 >> , 'fixed': False, 'min': -1, 'max': 10}
conf['params']['transversity']['u b']             = {'value': <<    6.94926778446999016126e-01 >> , 'fixed': False, 'min': 1e-5, 'max': 10}
conf['params']['transversity']['d N']             = {'value': <<   -2.00000000000000000000e+01 >> , 'fixed': False, 'min': -20, 'max': 20}
conf['params']['transversity']['d a']             = {'value': <<    1.02238771782567905433e-01 >> , 'fixed': False, 'min': -1, 'max': 5}
conf['params']['transversity']['d b']             = {'value': <<    8.04180710254932762382e-01 >> , 'fixed': False, 'min': 1e-5, 'max': 20}
...
conf['params']['pretzelosity']['widths0 valence'] = {'value': <<    1.66513138821539063983e-03 >>, 'fixed': False, 'min': 1e-5, 'max': 1}
conf['params']['pretzelosity']['widths0 sea']     = {'value': <<    1.26199935641373106598e-01 >>, 'fixed': False, 'min': 1e-5, 'max': 1}
conf['params']['pretzelosity']['u N']  = {'value': <<    1.00000000000000000000e+01 >> , 'fixed': False, 'min': -10, 'max': 10}
conf['params']['pretzelosity']['u a']  = {'value': <<    9.21393278780242575010e-01 >> , 'fixed': False, 'min': 1e-5, 'max': 5}
conf['params']['pretzelosity']['u b']  = {'value': <<    9.99999498142624076991e+00 >> , 'fixed': False, 'min': 1e-5, 'max': 10}
conf['params']['pretzelosity']['d N']  = {'value': <<   -1.00000000000000000000e+01 >> , 'fixed': False, 'min': -10, 'max': 10}
conf['params']['pretzelosity']['d a']  = {'value': <<    1.53594037872441058212e+00 >> , 'fixed': False, 'min': 1e-5, 'max': 5}
...
conf['datasets']['sidis']['filters'][2]['idx'] = [
