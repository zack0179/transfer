...
class PARMAN:
  ...
  def set_collins_params(self):
    ...
    if 'pi+ u N' in conf['params']['collins']: 
      ...
      conf['collins'].shape['pi+'][1][0]=conf['params']['collins']['pi+ u N']['value']
      conf['collins'].shape['pi+'][1][1]=conf['params']['collins']['pi+ u a']['value']
      conf['collins'].shape['pi+'][1][2]=conf['params']['collins']['pi+ u b']['value']
      conf['collins'].shape['pi+'][1][3]=conf['params']['collins']['pi+ u c']['value']
      conf['collins'].shape['pi+'][1][4]=conf['params']['collins']['pi+ u d']['value']

      conf['collins'].shape['pi+'][2][0]=conf['params']['collins']['pi+ d N']['value']
      conf['collins'].shape['pi+'][2][1]=conf['params']['collins']['pi+ d a']['value']
      conf['collins'].shape['pi+'][2][2]=conf['params']['collins']['pi+ d b']['value']
      conf['collins'].shape['pi+'][2][3]=conf['params']['collins']['pi+ d c']['value']
      conf['collins'].shape['pi+'][2][4]=conf['params']['collins']['pi+ d d']['value']

      conf['collins'].shape['pi+'][3][0]=conf['params']['collins']['pi+ d N']['value']
      conf['collins'].shape['pi+'][3][1]=conf['params']['collins']['pi+ d a']['value']
      conf['collins'].shape['pi+'][3][2]=conf['params']['collins']['pi+ d b']['value']
      conf['collins'].shape['pi+'][3][3]=conf['params']['collins']['pi+ d c']['value']
      conf['collins'].shape['pi+'][3][4]=conf['params']['collins']['pi+ d d']['value']

      conf['collins'].shape['pi+'][4][0]=conf['params']['collins']['pi+ u N']['value']
      conf['collins'].shape['pi+'][4][1]=conf['params']['collins']['pi+ u a']['value']
      conf['collins'].shape['pi+'][4][2]=conf['params']['collins']['pi+ u b']['value']
      conf['collins'].shape['pi+'][4][3]=conf['params']['collins']['pi+ u c']['value']
      conf['collins'].shape['pi+'][4][4]=conf['params']['collins']['pi+ u d']['value']

      conf['collins'].shape['pi+'][5][0]=conf['params']['collins']['pi+ d N']['value']
      conf['collins'].shape['pi+'][5][1]=conf['params']['collins']['pi+ d a']['value']
      conf['collins'].shape['pi+'][5][2]=conf['params']['collins']['pi+ d b']['value']
      conf['collins'].shape['pi+'][5][3]=conf['params']['collins']['pi+ d c']['value']
      conf['collins'].shape['pi+'][5][4]=conf['params']['collins']['pi+ d d']['value']

      conf['collins'].shape['pi+'][6][0]=conf['params']['collins']['pi+ d N']['value']
      conf['collins'].shape['pi+'][6][1]=conf['params']['collins']['pi+ d a']['value']
      conf['collins'].shape['pi+'][6][2]=conf['params']['collins']['pi+ d b']['value']
      conf['collins'].shape['pi+'][6][3]=conf['params']['collins']['pi+ d c']['value']
      conf['collins'].shape['pi+'][6][4]=conf['params']['collins']['pi+ d d']['value']

      conf['collins'].shape['pi+'][7][0]=conf['params']['collins']['pi+ c N']['value']
      conf['collins'].shape['pi+'][7][1]=conf['params']['collins']['pi+ c a']['value']
      conf['collins'].shape['pi+'][7][2]=conf['params']['collins']['pi+ c b']['value']
      conf['collins'].shape['pi+'][7][3]=conf['params']['collins']['pi+ c c']['value']
      conf['collins'].shape['pi+'][7][4]=conf['params']['collins']['pi+ c d']['value']

      conf['collins'].shape['pi+'][8][0]=conf['params']['collins']['pi+ c N']['value']
      conf['collins'].shape['pi+'][8][1]=conf['params']['collins']['pi+ c a']['value']
      conf['collins'].shape['pi+'][8][2]=conf['params']['collins']['pi+ c b']['value']
    ...
    if 'k+ u N' in conf['params']['collins']: 
      ...
      conf['collins'].shape['k+'][1][0]=conf['params']['collins']['k+ u N']['value']
      conf['collins'].shape['k+'][1][1]=conf['params']['collins']['k+ u a']['value']
      conf['collins'].shape['k+'][1][2]=conf['params']['collins']['k+ u b']['value']
      conf['collins'].shape['k+'][1][3]=conf['params']['collins']['k+ u c']['value']
      conf['collins'].shape['k+'][1][4]=conf['params']['collins']['k+ u d']['value']

      conf['collins'].shape['k+'][2][0]=conf['params']['collins']['k+ d N']['value']
      conf['collins'].shape['k+'][2][1]=conf['params']['collins']['k+ d a']['value']
      conf['collins'].shape['k+'][2][2]=conf['params']['collins']['k+ d b']['value']
      conf['collins'].shape['k+'][2][3]=conf['params']['collins']['k+ d c']['value']
      conf['collins'].shape['k+'][2][4]=conf['params']['collins']['k+ d d']['value']

      conf['collins'].shape['k+'][3][0]=conf['params']['collins']['k+ d N']['value']
      conf['collins'].shape['k+'][3][1]=conf['params']['collins']['k+ d a']['value']
      conf['collins'].shape['k+'][3][2]=conf['params']['collins']['k+ d b']['value']
      conf['collins'].shape['k+'][3][3]=conf['params']['collins']['k+ d c']['value']
      conf['collins'].shape['k+'][3][4]=conf['params']['collins']['k+ d d']['value']

      conf['collins'].shape['k+'][4][0]=conf['params']['collins']['k+ d N']['value']
      conf['collins'].shape['k+'][4][1]=conf['params']['collins']['k+ d a']['value']
      conf['collins'].shape['k+'][4][2]=conf['params']['collins']['k+ d b']['value']
      conf['collins'].shape['k+'][4][3]=conf['params']['collins']['k+ d c']['value']
      conf['collins'].shape['k+'][4][4]=conf['params']['collins']['k+ d d']['value']

      conf['collins'].shape['k+'][5][0]=conf['params']['collins']['k+ d N']['value']
      conf['collins'].shape['k+'][5][1]=conf['params']['collins']['k+ d a']['value']
      conf['collins'].shape['k+'][5][2]=conf['params']['collins']['k+ d b']['value']
      conf['collins'].shape['k+'][5][3]=conf['params']['collins']['k+ d c']['value']
      conf['collins'].shape['k+'][5][4]=conf['params']['collins']['k+ d d']['value']

      conf['collins'].shape['k+'][6][0]=conf['params']['collins']['k+ sb N']['value']
      conf['collins'].shape['k+'][6][1]=conf['params']['collins']['k+ sb a']['value']
      conf['collins'].shape['k+'][6][2]=conf['params']['collins']['k+ sb b']['value']
      conf['collins'].shape['k+'][6][3]=conf['params']['collins']['k+ sb c']['value']
      conf['collins'].shape['k+'][6][4]=conf['params']['collins']['k+ sb d']['value']
