...
conf['params']['collins']['widths0 k+ fav']     = {'value':<<    8.51755636265952298380e-02>>,'fixed':True,'min':1e-5,'max':1}
conf['params']['collins']['widths0 k+ unfav']   = {'value':<<    1.58329978654016323425e-01>>,'fixed':True,'min':1e-5,'max':2}
conf['params']['collins']['k+ u N']  = {'value':<<    1.18086487516282367949e+00>> ,'fixed':True,'min':-5,'max':20}
conf['params']['collins']['k+ u a']  = {'value':<<    3.08130941213963005509e-01>> ,'fixed':True,'min':-1,'max':5}
conf['params']['collins']['k+ u b']  = {'value':<<    2.18740937945325031322e+00>> ,'fixed':True,'min':1e-5,'max':10}
conf['params']['collins']['k+ d N']  = {'value':<<   -3.13181036040384164210e-01>> ,'fixed':True,'min':-10,'max':20}
conf['params']['collins']['k+ d a']  = {'value':<<   -6.76926749974947838950e-01>> ,'fixed':True,'min':-1,'max':10}
conf['params']['collins']['k+ d b']  = {'value':<<    2.20462195944863914576e+00>> ,'fixed':True,'min':1e-5,'max':20}
conf['params']['collins']['k+ sb N']  = {'value':<<   -3.80205342723590877796e+00>> ,'fixed':True,'min':-20,'max':20}
conf['params']['collins']['k+ sb a']  = {'value':<<   -8.58542778756333113677e-01>> ,'fixed':True,'min':-1,'max':5}
