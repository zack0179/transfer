...
conf['params']['transversity']['u d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['transversity']['d d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['transversity']['s d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
...
conf['params']['collins']['pi+ u d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['pi+ d d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
...
conf['params']['collins']['k+ u d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['k+ d d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['k+ sb d']  = {'value':<<    0.00000000000000000000e+00>> ,'fixed':False,'min':-10,'max':10}
