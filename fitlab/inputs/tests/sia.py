...
conf['params']['collins']={}
conf['params']['collins']['widths0 pi+ fav']     = {'value':<<    2.06136664220328114094e-01>>,'fixed':False,'min':1e-5,'max':1}
conf['params']['collins']['widths0 pi+ unfav']   = {'value':<<    6.03844037082248291659e-02>>,'fixed':False,'min':1e-5,'max':2}

conf['params']['collins']['pi+ u N 1']  = {'value':<<    1.00211434989559421638e+02>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['pi+ u a 1']  = {'value':<<    6.81083608892732339513e+00>> ,'fixed':False,'min':-1,'max':5}
conf['params']['collins']['pi+ u b 1']  = {'value':<<    4.28329727735617904472e+00>> ,'fixed':False,'min':1e-5,'max':10}
...
conf['params']['collins']['pi+ u N 2']  = {'value':<<    4.13899131563151012614e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['pi+ u a 2']  = {'value':<<   -1.08212212346586889034e+00>> ,'fixed':False,'min':-1,'max':5}
conf['params']['collins']['pi+ u b 2']  = {'value':<<    9.32944567193078810874e+00>> ,'fixed':False,'min':1e-5,'max':10}
...
conf['params']['collins']['pi+ d N 1']  = {'value':<<   -2.08810557389775441894e-01>> ,'fixed':False,'min':-10,'max':10}
conf['params']['collins']['pi+ d a 1']  = {'value':<<   -1.85408558065051232155e+00>> ,'fixed':False,'min':-1,'max':5}
conf['params']['collins']['pi+ d b 1']  = {'value':<<    2.00042039642265923050e+00>> ,'fixed':False,'min':1e-5,'max':10}
