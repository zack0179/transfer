...
conf['params']['collins']={}
conf['params']['collins']['widths0 pi+ fav']     = {'value':<<    7.32394956685192277668e-02>>,'fixed':False,'min':0.05,'max':1.24049999999999993605e-01}
conf['params']['collins']['widths0 pi+ unfav']   = {'value':<<    1.03323860236099393517e-01>>,'fixed':False,'min':1e-5,'max':1.43729999999999996652e-01}
conf['params']['collins']['pi+ u N 1']  = {'value':<<    7.61796977302304778590e-01>>,'fixed':False,'min':0,'max':4}
conf['params']['collins']['pi+ u a 1']  = {'value':<<   -1.76595478780987180656e+00>>,'fixed':False,'min':-2.5,'max':0}
conf['params']['collins']['pi+ u b 1']  = {'value':<<    5.09530463259986365898e+00>>,'fixed':False,'min':3.,'max':7.}

conf['params']['collins']['pi+ d N 1']  = {'value':<<   -3.36949180542311710340e+00>>,'fixed':False,'min':-15,'max':2}
conf['params']['collins']['pi+ d a 1']  = {'value':<<    1.05233079549012265019e+00>>,'fixed':False,'min': 0.,'max':4.5}
conf['params']['collins']['pi+ d b 1']  = {'value':<<    3.31252429102024859020e+00>>,'fixed':False,'min':2.5,'max':3.8}
...
conf['params']['collins']['pi+ u N 2']  = {'value':<<    1.43336154477928925388e+01>>,'fixed':False,'min':1,'max':52}
conf['params']['collins']['pi+ u a 2']  = {'value':<<    7.06446651543468551182e+00>>,'fixed':False,'min':1,'max':20}
conf['params']['collins']['pi+ u b 2']  = {'value':<<    3.16538360417999165008e+00>>,'fixed':False,'min':3,'max':25}
...
conf['params']['transversity']['u N']             = {'value':<<    9.06453198085613642832e+00>> ,'fixed':False,'min':-10,'max':10}
conf['params']['transversity']['u a']             = {'value':<<    1.02096282293105611316e+00>> ,'fixed':False,'min':-1,'max':10}
conf['params']['transversity']['u b']             = {'value':<<    1.84599586831199724557e+00>> ,'fixed':False,'min':1e-5,'max':10}
conf['params']['transversity']['d N']             = {'value':<<   -1.77375040929934186806e+01>> ,'fixed':False,'min':-20,'max':20}
conf['params']['transversity']['d a']             = {'value':<<    5.55000521297183135871e-01>> ,'fixed':False,'min':-1,'max':5}
conf['params']['transversity']['d b']             = {'value':<<    5.89689488926491467424e+00>> ,'fixed':False,'min':1e-5,'max':20}
conf['params']['transversity']['s N']             = {'value':<<   -7.56526514148701673124e-02>> ,'fixed':False,'min':-10,'max':10}
conf['params']['transversity']['s a']             = {'value':<<    6.02601474655629409938e-01>> ,'fixed':False,'min':-1,'max':5}
...
conf['params']['Htilde']['pi+ u N 1']  = {'value':<<    3.67967942554898341800e-01>>,'fixed':False,'min':-15,'max':15}
conf['params']['Htilde']['pi+ u a 1']  = {'value':<<    1.34107447858988315659e-01>>,'fixed':False,'min':-1,'max':5}
conf['params']['Htilde']['pi+ u b 1']  = {'value':<<    2.57770173495963295096e+00>>,'fixed':False,'min':0,'max':10}

conf['params']['Htilde']['pi+ d N 1']  = {'value':<<    3.60704648232910773942e+00>>,'fixed':False,'min':-15,'max':15}
conf['params']['Htilde']['pi+ d a 1']  = {'value':<<    2.40052150118638696341e+00>>,'fixed':False,'min': -1,'max':5}
conf['params']['Htilde']['pi+ d b 1']  = {'value':<<    1.17816054074179188405e+00>>,'fixed':False,'min':0,'max':10}
