...
class DSS:
    ...
    def get_f(self, z, Q2, hadron):
        ...
        """
        if hadron == 'pi+':
            return self._get_f(z, Q2, self.pi, dssfpi.fdss, 1, 1)
        elif hadron == 'pi-':
            return self._get_f(z, Q2, self.pi, dssfpi.fdss, 1, -1)
        elif hadron == 'pi0':
            return self._get_f(z, Q2, self.pi, dssfpi.fdss, 1, 0)
        elif hadron == 'k+':
            return self._get_f(z, Q2, self.k, dssfk.fdss, 2, 1)
        elif hadron == 'k-':
            return self._get_f(z, Q2, self.k, dssfk.fdss, 2, -1)
        elif hadron == 'k0':
            return self._get_f(z, Q2, self.k, dssfk.fdss, 2, 0)
        elif hadron == 'h+':
            return self._get_f(z, Q2, self.h, dssfh.fdss, 4, 1)
        elif hadron == 'h-':
            return self._get_f(z, Q2, self.h, dssfh.fdss, 4, -1)
        elif hadron == 'h0':
            return self._get_f(z, Q2, self.h, dssfh.fdss, 4, 0)
